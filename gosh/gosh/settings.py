# Django settings for GOSH-OPAL! project.
import os
...
OPAL_SCHEMA_MODULE = 'gosh.schema'
OPAL_OPTIONS_MODULE = 'gosh.options'
OPAL_TAGS_MODULE = 'gosh.tags'
OPAL_BRAND_NAME = 'GOSH-OPAL!'
